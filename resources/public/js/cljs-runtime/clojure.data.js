...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__39835){
...
var vec__39843 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39843,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39843,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39843,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_39962 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_39962(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_39964 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_39964(a,b);
}
});
...
var fexpr__39951 = (function (){var G__39952 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__39952__$1)].join('')));
