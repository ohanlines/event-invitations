...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_40169 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_40169(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_40170 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_40170(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_40171 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_40171(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_40172 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_40172(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_40174 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_40174(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_40176 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_40176(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__40161,callback){
var map__40162 = p__40161;
var map__40162__$1 = cljs.core.__destructure_map(map__40162);
var input = map__40162__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40162__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40162__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
